...
class SuperMarketOrder extends StatefulWidget {
  SuperMarketOrder({
    Key key,
    @required this.name,
  }) : super(key: key);
  ...
  @override
  _SuperMarketOrderState createState() => _SuperMarketOrderState();

  final myAddressController = TextEditingController();
  final myPhoneNumberController = TextEditingController();
}

class _SuperMarketOrderState extends State<SuperMarketOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    String superMarketName = widget.name;
    //
    return Scaffold(
      appBar: AppBar(
            ...
            child: GestureDetector(
              ...
              onTap: () {
                ...
                if (listBuyItem.isEmpty ||
                  ...
                  return materialDialog(context, superMarketName);
                }
              },
            ),
          )
